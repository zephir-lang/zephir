...
if test "$PHP_ZEPHIR" = "yes"; then
	...
	zephir_sources="zephir.c kernel/main.c kernel/fcall.c kernel/exceptions.c kernel/operators.c parser.c scanner.c builder.c utils.c classes.c blocks.c expr.c symtable.c variable.c statements/echo.c statements/let.c statements/if.c statements/while.c statements/declare.c statements/return.c operators/arithmetical.c operators/comparison.c"
