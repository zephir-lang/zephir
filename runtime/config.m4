...
if test "$PHP_ZEPHIR" = "yes"; then
	...
	zephir_sources="zephir.c kernel/main.c kernel/memory.c kernel/fcall.c kernel/exceptions.c kernel/operators.c kernel/string.c parser.c scanner.c builder.c utils.c classes.c blocks.c expr.c symtable.c variable.c errors.c fcall.c statements/echo.c statements/let.c statements/if.c statements/while.c statements/declare.c statements/return.c operators/arithmetical.c operators/comparison.c optimizers/evalexpr.c"
