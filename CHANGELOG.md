...
- Fixed `-V` CLI flag purpose. Initially it was intended to disabling verbose mode
  on the fly, e.g. override project configuration for a single Zephir pass. This
  behaviour was returned back.
