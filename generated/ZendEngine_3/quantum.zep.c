...
PHP_METHOD(Test_Quantum, harmos) {
	...
	int ZEPHIR_LAST_CALL_STATUS, i = 0, j = 0, n = 0, _13, _14, _16$$5, _17$$5, _35$$5, _36$$5;
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "w");
	ZEPHIR_CALL_FUNCTION(&fp, "fopen", NULL, 26, &_0, &_1);
		...
		while (1) {
			...
			if (_50$$5) {
				...
				while (1) {
					...
					ZEPHIR_CALL_FUNCTION(NULL, "fprintf", &_55, 54, &fp, &_52$$9, &_53$$9, &_54$$9, &_51$$9);
					zephir_check_call_status();
					i = (i + 10);
				}
				ZEPHIR_INIT_NVAR(&_56$$8);
				ZVAL_STRING(&_56$$8, "\n");
				ZEPHIR_CALL_FUNCTION(NULL, "fprintf", &_55, 54, &fp, &_56$$8);
				zephir_check_call_status();
			}
			j = 1;
			while (1) {
