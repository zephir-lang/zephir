...
PHP_METHOD(Test_TryTest, testTry4) {
	...
	/* try_start_1: */
		...
		if (a) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_2$$5, "__construct", NULL, 70, &_3$$5);
			zephir_check_call_status_or_jump(try_end_1);
...
PHP_METHOD(Test_TryTest, testTry9) {
	...
	/* try_start_1: */
		...
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "somemethod1", NULL, 71);
		zephir_check_call_status_or_jump(try_end_1);
...
PHP_METHOD(Test_TryTest, testTry10) {
	...
	/* try_start_1: */
		...
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "somemethod2", NULL, 72);
		zephir_check_call_status_or_jump(try_end_1);
		RETURN_MM_STRING("not catched");
