...
PHP_METHOD(Test_Scall, testCall3) {
	...
	ZEPHIR_RETURN_CALL_SELF("testmethod3", &_0, 57);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Test_Scall, testCall6) {
	...
	ZEPHIR_RETURN_CALL_SELF("testmethod6", &_0, 58, a, b);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Test_Scall, testCall13) {
	...
	ZEPHIR_RETURN_CALL_PARENT(test_scall_ce, this_ptr, "testmethod1", &_0, 0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Test_Scall, testCall14) {
	...
	ZEPHIR_RETURN_CALL_PARENT(test_scall_ce, this_ptr, "testmethod2", &_0, 0);
	zephir_check_call_status();
	RETURN_MM();
