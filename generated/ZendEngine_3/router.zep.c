...
PHP_METHOD(Test_Router, __construct) {
	...
	if (defaultRoutes == 1) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", &_3, 55, &_2$$3, &_1$$3);
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", &_3, 55, &_5$$3, &_4$$3);
		zephir_check_call_status();
...
PHP_METHOD(Test_Router, add) {
	...
	ZEPHIR_CALL_METHOD(NULL, &route, "__construct", NULL, 55, pattern, paths, httpMethods);
	zephir_check_call_status();
