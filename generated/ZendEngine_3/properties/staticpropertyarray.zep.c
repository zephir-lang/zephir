...
void zephir_init_static_properties_Test_Properties_StaticPropertyArray(TSRMLS_D) {
	...
	ZVAL_LONG(&_1, 4);
	zephir_array_fast_append(&_0, &_1);
	zephir_update_static_property_ce(test_properties_staticpropertyarray_ce, SL("someArray"), &_0);
	ZEPHIR_INIT_NVAR(&_1);
	array_init(&_1);
	zephir_update_static_property_ce(test_properties_staticpropertyarray_ce, SL("someEmptyArray"), &_1);
	ZEPHIR_MM_RESTORE();
