...
PHP_METHOD(Test_Fcall, testCall2) {
	...
	zval _0$$3 = zval_used_for_init, _1$$3 = zval_used_for_init;
...
PHP_METHOD(Test_Fcall, testCall3) {
	...
	zval *handle = NULL, *handle2 = NULL, *buffer = NULL, _0 = zval_used_for_init, _1 = zval_used_for_init, _3$$4 = zval_used_for_init;
...
PHP_METHOD(Test_Fcall, testFunctionGetArgs) {
	...
	zephir_get_args(return_value TSRMLS_CC);
	return;
...
PHP_METHOD(Test_Fcall, testFunctionGetArg) {
	...
	zval *param1, *param2, *_0 = NULL, _1, _2;
	...
	ZEPHIR_SINIT_VAR(_1);
	ZVAL_LONG(&_1, 0);
	zephir_get_arg(_0, zephir_get_intval(&_1) TSRMLS_CC);
	zephir_array_fast_append(return_value, _0);
	ZEPHIR_INIT_NVAR(_0);
	ZEPHIR_SINIT_VAR(_2);
	ZVAL_LONG(&_2, 1);
	zephir_get_arg(_0, zephir_get_intval(&_2) TSRMLS_CC);
	zephir_array_fast_append(return_value, _0);
	RETURN_MM();
