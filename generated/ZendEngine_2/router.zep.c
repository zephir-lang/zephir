...
PHP_METHOD(Test_Router, __construct) {
	...
	if (defaultRoutes == 1) {
		...
		ZEPHIR_CALL_METHOD(NULL, _0$$3, "__construct", &_3, 58, _2$$3, _1$$3);
		...
		ZEPHIR_CALL_METHOD(NULL, _2$$3, "__construct", &_3, 58, _5$$3, _4$$3);
	  ...
	  ; zephir_hash_move_backwards_ex(_3, &_2)
		...
		if (zephir_is_true(routeFound)) {
			...
			if (Z_TYPE_P(matches) == IS_ARRAY) {
				...
				for (
				  ; zephir_hash_get_current_data_ex(_11$$28, (void**) &_12$$28, &_10$$28) == SUCCESS
				  ; zephir_hash_move_forward_ex(_11$$28, &_10$$28)
				) {
...
PHP_METHOD(Test_Router, add) {
	...
	ZEPHIR_CALL_METHOD(NULL, route, "__construct", NULL, 58, pattern, paths, httpMethods);
	zephir_check_call_status();
