...
zend_class_entry *stub_traits_counter_ce;
zend_class_entry *stub_traits_nameable_ce;
...
zend_class_entry *stub_issue1628abstract_ce;
...
zend_class_entry *stub_17__closure_ce;
zend_class_entry *stub_18__closure_ce;
zend_class_entry *stub_19__closure_ce;
zend_class_entry *stub_1__closure_ce;
zend_class_entry *stub_20__closure_ce;
zend_class_entry *stub_21__closure_ce;
zend_class_entry *stub_22__closure_ce;
zend_class_entry *stub_23__closure_ce;
zend_class_entry *stub_24__closure_ce;
zend_class_entry *stub_25__closure_ce;
zend_class_entry *stub_26__closure_ce;
zend_class_entry *stub_27__closure_ce;
zend_class_entry *stub_28__closure_ce;
...
zend_class_entry *stub_constantparameterdefault_ce;
...
zend_class_entry *stub_issue1704_ce;
zend_class_entry *stub_issue1706_ce;
zend_class_entry *stub_issue1790_ce;
zend_class_entry *stub_issue2030_ce;
zend_class_entry *stub_issue2061_ce;
zend_class_entry *stub_issue2063_ce;
zend_class_entry *stub_issue2165_issue_ce;
zend_class_entry *stub_issue2167_ce;
zend_class_entry *stub_issue2324extended_ce;
zend_class_entry *stub_issue2385_ce;
zend_class_entry *stub_issue2394_ce;
zend_class_entry *stub_issue2409_ce;
zend_class_entry *stub_issue2428_ce;
zend_class_entry *stub_issue2469_ce;
zend_class_entry *stub_issue2505crosschain_ce;
zend_class_entry *stub_issue2505extended_ce;
zend_class_entry *stub_issue2522_ce;
zend_class_entry *stub_issue2533_ce;
zend_class_entry *stub_issue2537child_ce;
zend_class_entry *stub_issue2542_ce;
zend_class_entry *stub_issue2543_ce;
zend_class_entry *stub_issue2546_ce;
...
zend_class_entry *stub_traits_counteruser_ce;
...
static PHP_MINIT_FUNCTION(stub)
{
	...
	ZEPHIR_INIT(Stub_Traits_Counter);
	ZEPHIR_INIT(Stub_Traits_Nameable);
	...
	ZEPHIR_INIT(Stub_Issue1628Abstract);
	...
	ZEPHIR_INIT(Stub_ConstantParameterDefault);
	...
	ZEPHIR_INIT(Stub_Issue1704);
	ZEPHIR_INIT(Stub_Issue1706);
	ZEPHIR_INIT(Stub_Issue1790);
	ZEPHIR_INIT(Stub_Issue2030);
	ZEPHIR_INIT(Stub_Issue2061);
	ZEPHIR_INIT(Stub_Issue2063);
	ZEPHIR_INIT(Stub_Issue2165_Issue);
	ZEPHIR_INIT(Stub_Issue2167);
	ZEPHIR_INIT(Stub_Issue2324Extended);
	ZEPHIR_INIT(Stub_Issue2385);
	ZEPHIR_INIT(Stub_Issue2394);
	ZEPHIR_INIT(Stub_Issue2409);
	ZEPHIR_INIT(Stub_Issue2428);
	ZEPHIR_INIT(Stub_Issue2469);
	ZEPHIR_INIT(Stub_Issue2505CrossChain);
	ZEPHIR_INIT(Stub_Issue2505Extended);
	ZEPHIR_INIT(Stub_Issue2522);
	ZEPHIR_INIT(Stub_Issue2533);
	ZEPHIR_INIT(Stub_Issue2537Child);
	ZEPHIR_INIT(Stub_Issue2542);
	ZEPHIR_INIT(Stub_Issue2543);
	ZEPHIR_INIT(Stub_Issue2546);
	...
	ZEPHIR_INIT(Stub_Traits_CounterUser);
	...
	ZEPHIR_INIT(stub_17__closure);
	ZEPHIR_INIT(stub_18__closure);
	ZEPHIR_INIT(stub_19__closure);
	ZEPHIR_INIT(stub_1__closure);
	ZEPHIR_INIT(stub_20__closure);
	ZEPHIR_INIT(stub_21__closure);
	ZEPHIR_INIT(stub_22__closure);
	ZEPHIR_INIT(stub_23__closure);
	ZEPHIR_INIT(stub_24__closure);
	ZEPHIR_INIT(stub_25__closure);
	ZEPHIR_INIT(stub_26__closure);
	ZEPHIR_INIT(stub_27__closure);
	ZEPHIR_INIT(stub_28__closure);
