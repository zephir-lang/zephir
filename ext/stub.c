...
zend_class_entry *stub_piface_ce;
...
zend_class_entry *stub_pimpl_ce;
zend_class_entry *stub_precedencecheck_ce;
...
static PHP_MINIT_FUNCTION(stub)
{
	...
	ZEPHIR_INIT(Stub_PImpl);
	ZEPHIR_INIT(Stub_PdoStatement);
	ZEPHIR_INIT(Stub_PrecedenceCheck);
