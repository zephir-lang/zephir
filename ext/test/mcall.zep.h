...
ZEND_BEGIN_ARG_WITH_RETURN_OBJ_INFO_EX(arginfo_test_mcall_testmethod7, 0, 0, stdClass, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_test_mcall_testmethod7, 0, 0, IS_OBJECT, "stdClass", 0)
#endif
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(test_mcall_method_entry) {
	...
	PHP_ME(Test_Mcall, testMethod7, arginfo_test_mcall_testmethod7, ZEND_ACC_PRIVATE)
