...
PHP_METHOD(Test_Exceptions, testException2) {
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 27, &msg);
...
PHP_METHOD(Test_Exceptions, testException3) {
	...
	ZEPHIR_CALL_METHOD(NULL, &ex, "__construct", NULL, 27, &msg);
	zephir_check_call_status();
...
PHP_METHOD(Test_Exceptions, getException) {
	...
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 27, &_0);
	zephir_check_call_status();
	RETURN_MM();
...
PHP_METHOD(Test_Exceptions, testException5) {
	...
	ZEPHIR_CALL_METHOD(NULL, &exception, "__construct", NULL, 27, &_0);
	zephir_check_call_status();
...
PHP_METHOD(Test_Exceptions, issue1325) {
	...
	/* try_start_1: */
		...
		ZEPHIR_CALL_METHOD(&status, this_ptr, "donoopexception", NULL, 28);
		zephir_check_call_status_or_jump(try_end_1);
