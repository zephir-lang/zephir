...
PHP_METHOD(Test_Fcall, testCall2) {
	...
	while (1) {
		ZVAL_LONG(&_0$$3, 0);
		ZVAL_LONG(&_1$$3, 100);
		RETURN_MM_LONG(zephir_mt_rand(zephir_get_intval(&_0$$3), zephir_get_intval(&_1$$3) TSRMLS_CC));
	}
...
PHP_METHOD(Test_Fcall, testCall3) {
	...
	ZEPHIR_MM_ZVAL_STRING(&_0, "inputfile.txt");
	ZEPHIR_MM_ZVAL_STRING(&_1, "r");
	ZEPHIR_CALL_FUNCTION(&handle, "fopen", &_2, 31, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_MM_ZVAL_STRING(&_0, "outputfile.txt");
...
PHP_METHOD(Test_Fcall, testCall4) {
	...
	ZEPHIR_MM_ZVAL_STRING(&_0, "r");
	ZEPHIR_MM_ZVAL_STRING(&_1, "inputfile.txt");
	ZEPHIR_CALL_FUNCTION(&handle, "fopen", &_2, 31, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_MM_ZVAL_STRING(&_0, "outputfile.txt");
	ZEPHIR_MM_ZVAL_STRING(&_1, "w");
...
PHP_METHOD(Test_Fcall, testCall1FromVar) {
	...
	ZEPHIR_MM_ZVAL_STRING(&funcName, "strpos");
	ZEPHIR_MM_ZVAL_STRING(&_0, "hello");
	ZEPHIR_MM_ZVAL_STRING(&_1, "l");
