...
ZEPHIR_INIT_FUNCS(test_constants_method_entry) {
	PHP_ME(Test_Constants, getPropWsVarsGet, NULL, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Test_Constants, getPropertyC9, NULL, ZEND_ACC_PUBLIC)
	...
	PHP_ME(Test_Constants, testStringDelimiterConstantDoubleQuoted, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(Test_Constants, testStringConstantWithVars, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(Test_Constants, testStringPropertyWithVarsAssigned, NULL, ZEND_ACC_PUBLIC)
	PHP_ME(Test_Constants, testStringPropertyWithVarsGet, NULL, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
