...
ZEPHIR_INIT_CLASS(Test_Oo_OoConstructParams) {
	...
	zend_declare_property_null(test_oo_ooconstructparams_ce, SL("a"), ZEND_ACC_PROTECTED);

	zend_declare_property_null(test_oo_ooconstructparams_ce, SL("b"), ZEND_ACC_PROTECTED);
