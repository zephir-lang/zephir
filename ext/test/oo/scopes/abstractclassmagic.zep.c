...
ZEPHIR_INIT_CLASS(Test_Oo_Scopes_AbstractClassMagic) {
	...
	zend_declare_property_long(test_oo_scopes_abstractclassmagic_ce, SL("setCount"), 0, ZEND_ACC_PUBLIC);

	zend_declare_property_string(test_oo_scopes_abstractclassmagic_ce, SL("privateProperty"), "private", ZEND_ACC_PRIVATE);

	zend_declare_property_string(test_oo_scopes_abstractclassmagic_ce, SL("protectedProperty"), "protected", ZEND_ACC_PROTECTED);

	zend_declare_property_string(test_oo_scopes_abstractclassmagic_ce, SL("publicProperty"), "public", ZEND_ACC_PUBLIC);
