...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_test_bitwise_getint, 0, 1, IS_LONG, 0)
#else
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_test_bitwise_getint, 0, 1, IS_LONG, NULL, 0)
#endif
...
ZEPHIR_INIT_FUNCS(test_bitwise_method_entry) {
	...
	PHP_ME(Test_Bitwise, getInt, arginfo_test_bitwise_getint, ZEND_ACC_PROTECTED)
	PHP_ME(Test_Bitwise, testbitwiseXor, NULL, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
