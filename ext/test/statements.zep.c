...
PHP_METHOD(Test_Statements, test544Issue) {
	...
	if (ZEPHIR_GT_LONG(_0, step)) {
		...
		ZEPHIR_CALL_FUNCTION(&_7, "str_repeat", &_8, 15, _5, &_6);
		...
		ZEPHIR_CALL_FUNCTION(&_11, "str_repeat", &_8, 15, _10, &_6);
		zephir_check_call_status();
		...
		ZEPHIR_RETURN_CALL_FUNCTION("str_repeat", &_8, 15, _2, _3);
		zephir_check_call_status();
		RETURN_MM();
	} else {
...
PHP_METHOD(Test_Statements, test544IssueWithVariable) {
	...
	if (step < totalSteps) {
		...
		ZEPHIR_CALL_FUNCTION(&_5, "str_repeat", &_6, 15, _3, &_4);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&_9, "str_repeat", &_6, 15, _8, &_4);
		zephir_check_call_status();
		...
		_2 = zephir_fetch_nproperty_this(this_ptr, SL("width"), PH_NOISY_CC);
		ZEPHIR_RETURN_CALL_FUNCTION("str_repeat", &_6, 15, _1, _2);
		zephir_check_call_status();
		RETURN_MM();
	} else {
