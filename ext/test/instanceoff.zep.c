...
PHP_METHOD(Test_Instanceoff, testInstanceOf2) {
	...
	RETURN_MM_BOOL(zephir_instance_of_ev(&a, test_instanceoff_ce));
...
PHP_METHOD(Test_Instanceoff, testInstanceOf3) {
	...
	ZEPHIR_INIT_VAR(&a);
	object_init(&a);
	RETURN_MM_BOOL(zephir_instance_of_ev(&a, test_unknownclass_ce));
...
PHP_METHOD(Test_Instanceoff, testInstanceOf5) {
	...
	if (zephir_instance_of_ev(a, test_instanceoff_ce)) {
		RETURN_BOOL(1);
	}
	RETURN_BOOL(0);
...
PHP_METHOD(Test_Instanceoff, testInstanceOf7) {
	...
	RETURN_BOOL(zephir_instance_of_ev(test, test_instanceoff_ce));
