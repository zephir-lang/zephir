...
ZEND_BEGIN_ARG_INFO_EX(arginfo_test_assign_testarrayvarassign4, 0, 0, 1)
	ZEND_ARG_INFO(0, value)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(test_assign_method_entry) {
	...
	PHP_ME(Test_Assign, testArrayVarAssign4, arginfo_test_assign_testarrayvarassign4, ZEND_ACC_PUBLIC)
