...
ZEND_BEGIN_ARG_INFO_EX(arginfo_test_assign_teststaticpropertyarrayappend1, 0, 0, 1)
	ZEND_ARG_INFO(0, index)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(test_assign_method_entry) {
	...
	PHP_ME(Test_Assign, testStaticPropertyArrayAppend1, arginfo_test_assign_teststaticpropertyarrayappend1, ZEND_ACC_PUBLIC)
