...
PHP_METHOD(Test_Router, __construct) {
	...
	if (defaultRoutes == 1) {
		...
		ZEPHIR_CALL_METHOD(NULL, _0, "__construct", &_3, 52, _2, _1);
		...
		ZEPHIR_CALL_METHOD(NULL, _2, "__construct", &_3, 52, _5, _4);
...
PHP_METHOD(Test_Router, add) {
	...
	ZEPHIR_CALL_METHOD(NULL, route, "__construct", &_0, 52, pattern, paths, httpMethods);
	zephir_check_call_status();
