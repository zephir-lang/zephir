...
PHP_METHOD(Test_Oo, testInstance2) {
	...
	ZEPHIR_CALL_METHOD(NULL, o, "__construct", NULL, 48);
...
PHP_METHOD(Test_Oo, testInstance4) {
	...
	ZEPHIR_CALL_METHOD(NULL, o, "__construct", NULL, 49, a, b);
	zephir_check_call_status();
	RETURN_CCTOR(o);
...
PHP_METHOD(Test_Oo, testInstance5) {
	...
	ZEPHIR_CALL_METHOD(NULL, o, "__construct", NULL, 49, _0, _1);
...
PHP_METHOD(Test_Oo, testInstance9) {
	...
	ZEPHIR_CALL_CE_STATIC(&o, test_oo_oodynamica_ce, "getnew", &_0, 50);
	zephir_check_call_status();
	RETURN_CCTOR(o);
...
PHP_METHOD(Test_Oo, testInstance10) {
	...
	ZEPHIR_CALL_CE_STATIC(&o, test_oo_oodynamicb_ce, "getnew", &_0, 50);
	zephir_check_call_status();
	RETURN_CCTOR(o);
