...
PHP_METHOD(Test_Oo, createInstancesInLoop) {
	...
	ZEPHIR_MM_ZVAL_STRING(&_1, "OoDynamicA");
	zephir_array_fast_append(&_0, &_1);
	ZEPHIR_MM_ZVAL_STRING(&_1, "OoDynamicB");
	zephir_array_fast_append(&_0, &_1);
	...
	if (Z_TYPE_P(&_0) == IS_ARRAY) {
		ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _2)
		{
			...
			zephir_check_call_status();
			zephir_array_append(&result, &_6$$3, PH_SEPARATE, "test/oo.zep", 108);
			ZEPHIR_CALL_METHOD(&_7$$3, &instance, "execute2", NULL, 0);
			zephir_check_call_status();
			zephir_array_append(&result, &_7$$3, PH_SEPARATE, "test/oo.zep", 109);
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				zephir_check_call_status();
				zephir_array_append(&result, &_10$$4, PH_SEPARATE, "test/oo.zep", 108);
				ZEPHIR_CALL_METHOD(&_11$$4, &instance, "execute2", NULL, 0);
				zephir_check_call_status();
				zephir_array_append(&result, &_11$$4, PH_SEPARATE, "test/oo.zep", 109);
