...
ZEND_BEGIN_ARG_INFO_EX(arginfo_test_branchprediction_testbranch1, 0, 0, 1)
	ZEND_ARG_INFO(0, a)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(test_branchprediction_method_entry) {
	...
	PHP_ME(Test_BranchPrediction, testBranch1, arginfo_test_branchprediction_testbranch1, ZEND_ACC_PUBLIC)
  PHP_FE_END
};
