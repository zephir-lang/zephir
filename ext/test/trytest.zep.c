...
PHP_METHOD(Test_TryTest, testThrow1) {
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STR(zend_exception_get_default(TSRMLS_C), "error", "test/trytest.zep", 10);
	return;
...
PHP_METHOD(Test_TryTest, testThrow2) {
	...
	ZEPHIR_MM_ZVAL_STRING(&message, "error");
	object_init_ex(&_0, zend_exception_get_default(TSRMLS_C));ZEPHIR_MM_ADD_ENTRY(&_0);
...
PHP_METHOD(Test_TryTest, testTry2) {
	...
	/* try_start_1: */
		...
		object_init_ex(&_0$$3, zend_exception_get_default(TSRMLS_C));ZEPHIR_MM_ADD_ENTRY(&_0$$3);
		ZEPHIR_MM_ZVAL_STRING(&_1$$3, "error!");
...
PHP_METHOD(Test_TryTest, testTry4) {
	...
	/* try_start_1: */
		...
		if (a) {
			object_init_ex(&_0$$4, zend_exception_get_default(TSRMLS_C));ZEPHIR_MM_ADD_ENTRY(&_0$$4);
			ZEPHIR_MM_ZVAL_STRING(&_1$$4, "error!");
			...
			object_init_ex(&_2$$5, spl_ce_RuntimeException);ZEPHIR_MM_ADD_ENTRY(&_2$$5);
			ZEPHIR_MM_ZVAL_STRING(&_3$$5, "error!");
			ZEPHIR_CALL_METHOD(NULL, &_2$$5, "__construct", NULL, 84, &_3$$5);
			zephir_check_call_status_or_jump(try_end_1);
...
PHP_METHOD(Test_TryTest, testTry8) {
	...
	/* try_start_1: */
		...
		object_init_ex(&_0$$3, zend_exception_get_default(TSRMLS_C));ZEPHIR_MM_ADD_ENTRY(&_0$$3);
		ZEPHIR_MM_ZVAL_STRING(&_1$$3, "error 1!");
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 28, &_1$$3);
		zephir_check_call_status_or_jump(try_end_1);
...
PHP_METHOD(Test_TryTest, someMethod1) {
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_RuntimeException, "some external exception", "test/trytest.zep", 118);
	return;
...
PHP_METHOD(Test_TryTest, someMethod2) {
	...
	ZEPHIR_THROW_EXCEPTION_DEBUG_STR(spl_ce_DomainException, "some external exception", "test/trytest.zep", 123);
	return;
...
PHP_METHOD(Test_TryTest, testTry9) {
	...
	/* try_start_1: */
		...
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "somemethod1", NULL, 85);
		zephir_check_call_status_or_jump(try_end_1);
...
PHP_METHOD(Test_TryTest, testTry10) {
	...
	/* try_start_1: */
		...
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "somemethod2", NULL, 86);
		zephir_check_call_status_or_jump(try_end_1);
		RETURN_MM_STRING("not catched");
