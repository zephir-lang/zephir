...
PHP_METHOD(Test_BuiltIn_IntMethods, getAbs) {
	...
	ZVAL_LONG(&_0, num);
	ZEPHIR_CALL_FUNCTION(&_1, "abs", NULL, 7, &_0);
...
PHP_METHOD(Test_BuiltIn_IntMethods, getBinary) {
	...
	ZVAL_LONG(&_0, num);
	ZEPHIR_CALL_FUNCTION(&_1, "decbin", NULL, 8, &_0);
	zephir_check_call_status();
	RETURN_CCTOR(&_1);
...
PHP_METHOD(Test_BuiltIn_IntMethods, getHex) {
	...
	ZVAL_LONG(&_0, num);
	ZEPHIR_CALL_FUNCTION(&_1, "dechex", NULL, 9, &_0);
	zephir_check_call_status();
	RETURN_CCTOR(&_1);
...
PHP_METHOD(Test_BuiltIn_IntMethods, getOctal) {
	...
	ZVAL_LONG(&_0, num);
	ZEPHIR_CALL_FUNCTION(&_1, "decoct", NULL, 10, &_0);
	zephir_check_call_status();
	RETURN_CCTOR(&_1);
...
PHP_METHOD(Test_BuiltIn_IntMethods, getAsin) {
	...
	ZVAL_LONG(&_0, num);
	ZEPHIR_CALL_FUNCTION(&_1, "asin", NULL, 11, &_0);
	zephir_check_call_status();
	RETURN_CCTOR(&_1);
...
PHP_METHOD(Test_BuiltIn_IntMethods, getAcos) {
	...
	ZVAL_LONG(&_0, num);
	ZEPHIR_CALL_FUNCTION(&_1, "acos", NULL, 12, &_0);
	zephir_check_call_status();
	RETURN_CCTOR(&_1);
