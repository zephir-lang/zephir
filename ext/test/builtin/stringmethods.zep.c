...
PHP_METHOD(Test_BuiltIn_StringMethods, getSha1) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "sha1", NULL, 15, str);
	zephir_check_call_status();
	RETURN_CCTOR(_0);
...
PHP_METHOD(Test_BuiltIn_StringMethods, getNl2br) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "nl2br", NULL, 16, str);
	zephir_check_call_status();
	RETURN_CCTOR(_0);
...
PHP_METHOD(Test_BuiltIn_StringMethods, getParsedCsv) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "str_getcsv", NULL, 17, str);
	zephir_check_call_status();
	RETURN_CCTOR(_0);
...
PHP_METHOD(Test_BuiltIn_StringMethods, getRepeatted) {
	...
	ZEPHIR_SINIT_VAR(_0);
	ZVAL_LONG(&_0, count);
	ZEPHIR_CALL_FUNCTION(&_1, "str_repeat", NULL, 18, str, &_0);
	zephir_check_call_status();
	RETURN_CCTOR(_1);
...
PHP_METHOD(Test_BuiltIn_StringMethods, getShuffled) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "str_shuffle", NULL, 19, str);
	zephir_check_call_status();
	RETURN_CCTOR(_0);
...
PHP_METHOD(Test_BuiltIn_StringMethods, getSplited) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "str_split", NULL, 20, str, del);
	zephir_check_call_status();
	RETURN_CCTOR(_0);
...
PHP_METHOD(Test_BuiltIn_StringMethods, getCompare) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "strcmp", NULL, 21, left, right);
	zephir_check_call_status();
	RETURN_CCTOR(_0);
...
PHP_METHOD(Test_BuiltIn_StringMethods, getCompareLocale) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "strcoll", NULL, 22, left, right);
	zephir_check_call_status();
	RETURN_CCTOR(_0);
...
PHP_METHOD(Test_BuiltIn_StringMethods, getReversed) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "strrev", NULL, 23, str);
	zephir_check_call_status();
	RETURN_CCTOR(_0);
...
PHP_METHOD(Test_BuiltIn_StringMethods, getHtmlSpecialChars) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "htmlspecialchars", NULL, 24, str);
	zephir_check_call_status();
	RETURN_CCTOR(_0);
