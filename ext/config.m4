...
if test "$PHP_TEST" = "yes"; then
	...
	test_sources="test.c kernel/main.c kernel/memory.c kernel/exception.c kernel/hash.c kernel/debug.c kernel/backtrace.c kernel/object.c kernel/array.c kernel/string.c kernel/fcall.c kernel/alternative/fcall.c kernel/operators.c arithmetic.c assign.c cast.c declare.c fcall.c fibonnaci.c flow.c nativearray.c oo/ooconstruct.c oo/ooconstructparams.c oo/oonoconstruct.c oo.c router/exception.c router/route.c router.c"
