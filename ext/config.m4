...
if test "$PHP_TEST" = "yes"; then
	...
	test_sources="test.c kernel/main.c kernel/memory.c kernel/exception.c kernel/hash.c kernel/debug.c kernel/backtrace.c kernel/object.c kernel/array.c kernel/string.c kernel/fcall.c kernel/alternative/fcall.c kernel/operators.c kernel/concat.c flow.c nativearray.c scall.c regexdna.c router/route.c router/exception.c mcall.c oo.c fcall.c assign.c fibonnaci.c declare.c arithmetic.c properties/publicproperties.c properties/protectedproperties.c cast.c oo/oonoconstruct.c oo/ooconstruct.c oo/ooconstructparams.c constants.c router.c"
