...
PHP_METHOD(Test_Router_Route, compilePattern) {
	...
	zval *pattern, *compiledPattern = NULL, *idPattern, *_0, *_1, *_2, *_3, *_4, *_5, *_6, *_7, *_8, *_9, *_10, *_11, *_12, *_13;
	...
	if (zephir_memnstr_str(pattern, SL(":"))) {
		...
		if (zephir_memnstr_str(pattern, SL("/:controller"))) {
			ZEPHIR_INIT_VAR(_2);
			ZVAL_STRING(_2, "/:controller", 1);
			ZEPHIR_INIT_VAR(_3);
			zephir_call_func_p3(_3, "str_replace", _2, idPattern, compiledPattern);

			ZEPHIR_CPY_WRT(compiledPattern, _3);

		}
		//missing comment
		if (zephir_memnstr_str(pattern, SL("/:namespace"))) {
			ZEPHIR_INIT_VAR(_4);
			ZVAL_STRING(_4, "/:namespace", 1);
			ZEPHIR_INIT_VAR(_5);
			zephir_call_func_p3(_5, "str_replace", _4, idPattern, compiledPattern);

			ZEPHIR_CPY_WRT(compiledPattern, _5);

		}
		//missing comment
		if (zephir_memnstr_str(pattern, SL("/:action"))) {
			ZEPHIR_INIT_VAR(_6);
			ZVAL_STRING(_6, "/:action", 1);
			ZEPHIR_INIT_VAR(_7);
			zephir_call_func_p3(_7, "str_replace", _6, idPattern, compiledPattern);

			ZEPHIR_CPY_WRT(compiledPattern, _7);

		}
		//missing comment
		if (zephir_memnstr_str(pattern, SL("/:params"))) {
			ZEPHIR_INIT_VAR(_8);
			ZVAL_STRING(_8, "/:params", 1);
			ZEPHIR_INIT_VAR(_9);
			ZVAL_STRING(_9, "(/.*)*", 1);
			ZEPHIR_INIT_VAR(_10);
			zephir_call_func_p3(_10, "str_replace", _8, _9, compiledPattern);

			ZEPHIR_CPY_WRT(compiledPattern, _10);

		}
		//missing comment
		if (zephir_memnstr_str(pattern, SL("/:int"))) {
			ZEPHIR_INIT_VAR(_11);
			ZVAL_STRING(_11, "/:int", 1);
			ZEPHIR_INIT_VAR(_12);
			ZVAL_STRING(_12, "/([0-9]+)", 1);
			ZEPHIR_INIT_VAR(_13);
			zephir_call_func_p3(_13, "str_replace", _11, _12, compiledPattern);

			ZEPHIR_CPY_WRT(compiledPattern, _13);
...
PHP_METHOD(Test_Router_Route, extractNamedParams) {
	...
	int cursor, cursorVar, marker, bracketCount = 0, parenthesesCount = 0, foundPattern = 0, intermediate = 0, numberMatches = 0, _2, _8, _18;
	zend_bool notValid;
	char ch;
	zval *pattern_param = NULL, *tmp = NULL, *matches = NULL, *_0, *_1, *_3 = NULL, *_4 = NULL, *_5 = NULL, *_6 = NULL, *_9 = NULL, *_10 = NULL, *_11 = NULL, *_12 = NULL, *_14 = NULL, *_15 = NULL, *_16 = NULL, *_19, *_20;
	zephir_str *pattern = NULL, *route = NULL, *item = NULL, *variable = NULL, *regexp = NULL, *_7 = NULL, *_13 = NULL, *_17 = NULL;
						...
						if (bracketCount == 0) {
							...
							for (_8 = 0; _8 < item->len; _8++) {
								...
								if ((ch >= 'a' && ch <= 'z') || (ch >= 'A' && ch <= 'Z') || (ch >= '0' && ch <= '9') || ch == '-' || ch == '_' || ch == ':') {
									if (ch == ':') {
										ZEPHIR_INIT_NVAR(_9);
										ZVAL_STRINGL(_9, item->str, item->len, 1);
										ZEPHIR_INIT_NVAR(_10);
										ZVAL_LONG(_10, 0);
										ZEPHIR_INIT_NVAR(_11);
										ZVAL_LONG(_11, cursorVar);
										ZEPHIR_INIT_NVAR(_12);
										zephir_call_func_p3(_12, "substr", _9, _10, _11);
										zephir_get_strval(_12, &_13);

										zephir_str_assign(variable, _13->str, _13->len);

										ZEPHIR_INIT_NVAR(_14);
										ZVAL_STRINGL(_14, item->str, item->len, 1);
										ZEPHIR_INIT_NVAR(_15);
										ZVAL_LONG(_15, cursorVar + 1);
										ZEPHIR_INIT_NVAR(_16);
										zephir_call_func_p2(_16, "substr", _14, _15);
										zephir_get_strval(_16, &_17);

										zephir_str_assign(regexp, _17->str, _17->len);
	...
	array_init(_19);
	ZEPHIR_INIT_VAR(_20);
	ZVAL_STRINGL(_20, route->str, route->len, 1);
	zephir_array_append(&_19, _20, 0);
	zephir_array_append(&_19, matches, 0);
	RETURN_CCTOR(_19);
