...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_MASK_EX(arginfo_stub_typehinting_testabstract_returnoneofscalar, 0, 0, MAY_BE_LONG|MAY_BE_DOUBLE|MAY_BE_STRING|MAY_BE_BOOL)
ZEND_END_ARG_INFO()
