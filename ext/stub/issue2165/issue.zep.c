...
PHP_METHOD(Stub_Issue2165_Issue, build)
{
	...
	ZVAL_BOOL(&_0, 1);
	ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 49, &a, &_0);
...
PHP_METHOD(Stub_Issue2165_Issue, __construct)
{
	...
	ZEPHIR_CALL_FUNCTION(&_0, "current", NULL, 44, &a);
	zephir_check_call_status();
	n = zephir_fast_count_int(&_0);
	if (validate) {
		ZEPHIR_CALL_FUNCTION(&_1$$3, "array_values", &_2, 50, &a);
		zephir_check_call_status();
		...
		if (Z_TYPE_P(&a) == IS_ARRAY) {
			ZEND_HASH_FOREACH_KEY_VAL(Z_ARRVAL_P(&a), _5$$3, _6$$3, _3$$3)
			{
				...
				if (UNEXPECTED(zephir_fast_count_int(&rowA) != n)) {
					...
					ZVAL_LONG(&_8$$5, n);
					ZEPHIR_CALL_FUNCTION(&_9$$5, "strval", &_10, 51, &_8$$5);
					zephir_check_call_status();
					...
					ZEPHIR_CALL_METHOD(NULL, &_7$$5, "__construct", &_13, 52, &_12$$5);
					zephir_check_call_status();
				...
				if (Z_TYPE_P(&rowA) == IS_ARRAY) {
					ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&rowA), _14$$4)
					{
						...
						if (_16$$6) {
							ZEPHIR_CALL_FUNCTION(&_17$$6, "is_float", &_18, 53, &valueA);
							zephir_check_call_status();
						...
						if (UNEXPECTED(_16$$6)) {
							...
							ZEPHIR_CALL_METHOD(NULL, &_19$$7, "__construct", &_13, 52, &_21$$7);
							zephir_check_call_status();
					...
					while (1) {
						...
						zephir_check_call_status();
							...
							if (_22$$8) {
								ZEPHIR_CALL_FUNCTION(&_23$$8, "is_float", &_18, 53, &valueA);
								zephir_check_call_status();
							...
							if (UNEXPECTED(_22$$8)) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_24$$9, "__construct", &_13, 52, &_26$$9);
								zephir_check_call_status();
				...
				ZEPHIR_INIT_NVAR(&valueA);
				ZEPHIR_CALL_FUNCTION(&_27$$4, "array_values", &_2, 50, &rowA);
				zephir_check_call_status();
			...
			while (1) {
				...
				zephir_check_call_status();
					if (UNEXPECTED(zephir_fast_count_int(&rowA) != n)) {
						...
						ZVAL_LONG(&_29$$11, n);
						ZEPHIR_CALL_FUNCTION(&_30$$11, "strval", &_10, 51, &_29$$11);
						zephir_check_call_status();
						...
						ZEPHIR_CALL_METHOD(NULL, &_28$$11, "__construct", &_13, 52, &_32$$11);
						zephir_check_call_status();
					...
					if (Z_TYPE_P(&rowA) == IS_ARRAY) {
						ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&rowA), _33$$10)
						{
							...
							if (_35$$12) {
								ZEPHIR_CALL_FUNCTION(&_36$$12, "is_float", &_18, 53, &valueA);
								zephir_check_call_status();
							...
							if (UNEXPECTED(_35$$12)) {
								...
								ZEPHIR_CALL_METHOD(NULL, &_37$$13, "__construct", &_13, 52, &_39$$13);
								zephir_check_call_status();
						...
						while (1) {
							...
							zephir_check_call_status();
								...
								if (_40$$14) {
									ZEPHIR_CALL_FUNCTION(&_41$$14, "is_float", &_18, 53, &valueA);
									zephir_check_call_status();
								...
								if (UNEXPECTED(_40$$14)) {
									...
									ZEPHIR_CALL_METHOD(NULL, &_42$$15, "__construct", &_13, 52, &_44$$15);
									zephir_check_call_status();
					...
					ZEPHIR_INIT_NVAR(&valueA);
					ZEPHIR_CALL_FUNCTION(&_45$$10, "array_values", &_2, 50, &rowA);
					zephir_check_call_status();
...
PHP_METHOD(Stub_Issue2165_Issue, fill)
{
	...
	if (_0) {
		ZEPHIR_CALL_FUNCTION(&_1, "is_float", NULL, 53, value);
		zephir_check_call_status();
	...
	if (UNEXPECTED(_0)) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_2$$3, "__construct", NULL, 52, &_4$$3);
		zephir_check_call_status();
	...
	if (UNEXPECTED(m < 1)) {
		...
		ZVAL_LONG(&_6$$4, m);
		ZEPHIR_CALL_FUNCTION(&_7$$4, "strval", &_8, 51, &_6$$4);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_9$$4);
		ZEPHIR_CONCAT_SSVS(&_9$$4, "M must be", " greater than 0, ", &_7$$4, " given.");
		ZEPHIR_CALL_METHOD(NULL, &_5$$4, "__construct", NULL, 52, &_9$$4);
		zephir_check_call_status();
	...
	if (UNEXPECTED(n < 1)) {
		...
		ZVAL_LONG(&_11$$5, n);
		ZEPHIR_CALL_FUNCTION(&_12$$5, "strval", &_8, 51, &_11$$5);
		zephir_check_call_status();
		ZEPHIR_INIT_VAR(&_13$$5);
		ZEPHIR_CONCAT_SSVS(&_13$$5, "N must be", " greater than 0, ", &_12$$5, " given.");
		ZEPHIR_CALL_METHOD(NULL, &_10$$5, "__construct", NULL, 52, &_13$$5);
		zephir_check_call_status();
