...
PHP_METHOD(Stub_ArrayAccessTest, get)
{
	...
	zephir_array_fetch_string(&_0, &arr, SL("two"), PH_NOISY, "stub/arrayaccesstest.zep", 29);
	RETURN_CCTOR(&_0);
}
...
PHP_METHOD(Stub_ArrayAccessTest, unsetByKeyFromProperty)
{
	...
	zval key_zv, *dataFromProperty_param = NULL;
	zend_string *key = NULL;
	...
	if (UNEXPECTED(!_zephir_prop_0)) {
		_zephir_prop_0 = zend_string_init("assigedFromMethod", 17, 1);
	}

	ZEND_PARSE_PARAMETERS_START(2, 2)
		Z_PARAM_STR(key)
		ZEPHIR_Z_PARAM_ARRAY(dataFromProperty, dataFromProperty_param)
	ZEND_PARSE_PARAMETERS_END();
	ZEPHIR_METHOD_GLOBALS_PTR = pecalloc(1, sizeof(zephir_method_globals), 0);
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
...
PHP_METHOD(Stub_ArrayAccessTest, issue645)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	array_init(&_0);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 13, &_0);
	zephir_memory_observe(&_1);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 13, PH_NOISY_CC);
	RETURN_CCTOR(&_1);
}
...
PHP_METHOD(Stub_ArrayAccessTest, issue1094Test1)
{
	...
	ZEND_PARSE_PARAMETERS_START(0, 1)
		Z_PARAM_OPTIONAL
		ZEPHIR_Z_PARAM_ARRAY_OR_NULL(items, items_param)
	ZEND_PARSE_PARAMETERS_END();
	ZEPHIR_METHOD_GLOBALS_PTR = pecalloc(1, sizeof(zephir_method_globals), 0);
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
...
PHP_METHOD(Stub_ArrayAccessTest, issue1259UnsetStringKeyFromArrayProperty)
{
	...
	static zend_string *_zephir_prop_0 = NULL;
	if (UNEXPECTED(!_zephir_prop_0)) {
		_zephir_prop_0 = zend_string_init("unsetData", 9, 1);
	}
	ZEPHIR_METHOD_GLOBALS_PTR = pecalloc(1, sizeof(zephir_method_globals), 0);
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
