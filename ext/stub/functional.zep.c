...
PHP_METHOD(Stub_Functional, map1)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	ZEPHIR_INIT_NVAR(&_0);
	zephir_create_closure_ex(&_0, NULL, stub_48__closure_ce, SL("__invoke"));
	ZEPHIR_CALL_FUNCTION(&_1, "array_map", NULL, 16, &_0, &a);
...
PHP_METHOD(Stub_Functional, map2)
{
	...
	zephir_get_arrval(&a, a_param);
	ZEPHIR_CALL_FUNCTION(&_0, "array_map", NULL, 16, b, &a);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
}
