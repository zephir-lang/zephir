...
PHP_METHOD(Stub_Mcall, testCall3)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "testmethod3", NULL, 70);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Stub_Mcall, testCall6)
{
	...
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	zephir_fetch_params(1, 2, 0, &a, &b);
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "testmethod6", NULL, 71, a, b);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Stub_Mcall, testCall9)
{
	...
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	zephir_fetch_params(1, 2, 0, &a, &b);
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "testmethod6", NULL, 71, a, b);
	zephir_check_call_status();
...
PHP_METHOD(Stub_Mcall, testCall18)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "testmethod7", NULL, 72);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Stub_Mcall, testCall22)
{
	...
	if (_1 <= _2) {
		while (1) {
			...
			i = _1;
			ZEPHIR_CALL_METHOD(&_3$$3, this_ptr, "testmethod21", &_4, 73, p, p);
			zephir_check_call_status();
			j += zephir_get_numberval(&_3$$3);
		}
	}
...
PHP_METHOD(Stub_Mcall, testCallablePass)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	ZEPHIR_INIT_NVAR(&_0);
	zephir_create_closure_ex(&_0, NULL, stub_47__closure_ce, SL("__invoke"));
	ZEPHIR_RETURN_CALL_METHOD(&a, "setcallable", NULL, 74, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Stub_Mcall, aa)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(&a, "bb", NULL, 75);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Stub_Mcall, issue1136)
{
	...
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, ">=");
	ZEPHIR_CALL_FUNCTION(&_3, "version_compare", NULL, 76, &_0, &_1, &_2);
	zephir_check_call_status();
	if (zephir_is_true(&_3)) {
		...
		ZEPHIR_CALL_FUNCTION(&_finfo, "finfo_open", NULL, 77);
		zephir_check_call_status();
	}
	RETURN_CCTOR(&_finfo);
}
