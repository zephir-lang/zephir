...
PHP_METHOD(stub_16__closure, __invoke)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 146, PH_NOISY_CC | PH_READONLY);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_1, 147, PH_NOISY_CC | PH_READONLY);
