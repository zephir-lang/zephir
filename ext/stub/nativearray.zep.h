...
extern zend_class_entry *stub_nativearray_ce;
...
ZEPHIR_INIT_FUNCS(stub_nativearray_method_entry) {
	...
	PHP_ME(Stub_NativeArray, testArray3, arginfo_stub_nativearray_testarray3, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray4, arginfo_stub_nativearray_testarray4, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray5, arginfo_stub_nativearray_testarray5, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray6, arginfo_stub_nativearray_testarray6, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray7, arginfo_stub_nativearray_testarray7, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray8, arginfo_stub_nativearray_testarray8, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray9, arginfo_stub_nativearray_testarray9, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray10, arginfo_stub_nativearray_testarray10, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray11, arginfo_stub_nativearray_testarray11, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray12, arginfo_stub_nativearray_testarray12, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray13, arginfo_stub_nativearray_testarray13, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray14, arginfo_stub_nativearray_testarray14, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray15, arginfo_stub_nativearray_testarray15, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray16, arginfo_stub_nativearray_testarray16, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray17, arginfo_stub_nativearray_testarray17, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray18, arginfo_stub_nativearray_testarray18, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray19, arginfo_stub_nativearray_testarray19, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray20, arginfo_stub_nativearray_testarray20, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray21, arginfo_stub_nativearray_testarray21, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray22, arginfo_stub_nativearray_testarray22, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray23, arginfo_stub_nativearray_testarray23, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray24, arginfo_stub_nativearray_testarray24, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray25, arginfo_stub_nativearray_testarray25, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray26, arginfo_stub_nativearray_testarray26, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray27, arginfo_stub_nativearray_testarray27, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray28, arginfo_stub_nativearray_testarray28, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray29, arginfo_stub_nativearray_testarray29, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArray30, arginfo_stub_nativearray_testarray30, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArrayAccess1, arginfo_stub_nativearray_testarrayaccess1, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArrayAccess2, arginfo_stub_nativearray_testarrayaccess2, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArrayAccess3, arginfo_stub_nativearray_testarrayaccess3, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArrayAccess4, arginfo_stub_nativearray_testarrayaccess4, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArrayAccess5, arginfo_stub_nativearray_testarrayaccess5, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArrayAccess6, arginfo_stub_nativearray_testarrayaccess6, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArrayMultipleAccess1, arginfo_stub_nativearray_testarraymultipleaccess1, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArrayMultipleAccess2, arginfo_stub_nativearray_testarraymultipleaccess2, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArrayMultipleAccess3, arginfo_stub_nativearray_testarraymultipleaccess3, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArrayMultipleAccess4, arginfo_stub_nativearray_testarraymultipleaccess4, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArrayMultipleAccess5, arginfo_stub_nativearray_testarraymultipleaccess5, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArrayUpdate1, arginfo_stub_nativearray_testarrayupdate1, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArrayUpdate2, arginfo_stub_nativearray_testarrayupdate2, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArrayUpdate3, arginfo_stub_nativearray_testarrayupdate3, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArrayUpdate4, arginfo_stub_nativearray_testarrayupdate4, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArrayUpdate5, arginfo_stub_nativearray_testarrayupdate5, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArrayAppend1, arginfo_stub_nativearray_testarrayappend1, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArrayAppend2, arginfo_stub_nativearray_testarrayappend2, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testMultipleArrayUpdate1, arginfo_stub_nativearray_testmultiplearrayupdate1, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testMultipleArrayUpdate2, arginfo_stub_nativearray_testmultiplearrayupdate2, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testMultipleArrayUpdate3, arginfo_stub_nativearray_testmultiplearrayupdate3, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testMultipleArrayUpdate4, arginfo_stub_nativearray_testmultiplearrayupdate4, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testMultipleArrayUpdate5, arginfo_stub_nativearray_testmultiplearrayupdate5, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testMultipleArrayUpdate6, arginfo_stub_nativearray_testmultiplearrayupdate6, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testMultipleArrayUpdate7, arginfo_stub_nativearray_testmultiplearrayupdate7, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testMultipleArrayUpdate8, arginfo_stub_nativearray_testmultiplearrayupdate8, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testMultipleArrayUpdate9, arginfo_stub_nativearray_testmultiplearrayupdate9, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testMultipleArrayUpdate10, arginfo_stub_nativearray_testmultiplearrayupdate10, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testMultipleArrayUpdate11, arginfo_stub_nativearray_testmultiplearrayupdate11, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testMultipleArrayUpdate12, arginfo_stub_nativearray_testmultiplearrayupdate12, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testMultipleArrayUpdate13, arginfo_stub_nativearray_testmultiplearrayupdate13, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testMultipleArrayAppend1, arginfo_stub_nativearray_testmultiplearrayappend1, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testMultipleArrayAppend2, arginfo_stub_nativearray_testmultiplearrayappend2, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testMultipleArrayAppend3, arginfo_stub_nativearray_testmultiplearrayappend3, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testArrayKeys, arginfo_stub_nativearray_testarraykeys, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, testImplodeArray, arginfo_stub_nativearray_testimplodearray, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, issue110, arginfo_stub_nativearray_issue110, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, issue264, arginfo_stub_nativearray_issue264, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, issue743a, arginfo_stub_nativearray_issue743a, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_NativeArray, issue743b, arginfo_stub_nativearray_issue743b, ZEND_ACC_PUBLIC)
