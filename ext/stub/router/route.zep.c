...
PHP_METHOD(Stub_Router_Route, __construct)
{
	...
	if (UNEXPECTED(!_zephir_prop_0)) {
		_zephir_prop_0 = zend_string_init("_methods", 8, 1);
	}
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 114, httpMethods);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Stub_Router_Route, reConfigure)
{
	...
	if (UNEXPECTED(!_zephir_prop_0)) {
		_zephir_prop_0 = zend_string_init("_pattern", 8, 1);
	}
	if (UNEXPECTED(!_zephir_prop_1)) {
		_zephir_prop_1 = zend_string_init("_compiledPattern", 16, 1);
	}
	if (UNEXPECTED(!_zephir_prop_2)) {
		_zephir_prop_2 = zend_string_init("_paths", 6, 1);
	}
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 115, pattern);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 116, &compiledPattern);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 117, &routePaths);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Stub_Router_Route, setName)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 118, name);
	RETURN_THISW();
}
...
PHP_METHOD(Stub_Router_Route, beforeMatch)
{
	...
	static zend_string *_zephir_prop_0 = NULL;
	if (UNEXPECTED(!_zephir_prop_0)) {
		_zephir_prop_0 = zend_string_init("_beforeMatch", 12, 1);
	}
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 119, callback);
	RETURN_THISW();
}
...
PHP_METHOD(Stub_Router_Route, setHostname)
{
	...
	static zend_string *_zephir_prop_0 = NULL;
	if (UNEXPECTED(!_zephir_prop_0)) {
		_zephir_prop_0 = zend_string_init("_hostname", 9, 1);
	}
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 120, hostname);
	RETURN_THISW();
}
