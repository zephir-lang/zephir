...
PHP_METHOD(Stub_Oo, testInstance2)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &o, "__construct", NULL, 77);
...
PHP_METHOD(Stub_Oo, testInstance4)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &o, "__construct", NULL, 78, &a, &b);
	zephir_check_call_status();
	RETURN_CCTOR(&o);
}
...
PHP_METHOD(Stub_Oo, testInstance5)
{
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "b");
	ZEPHIR_CALL_METHOD(NULL, &o, "__construct", NULL, 78, &_0, &_1);
	zephir_check_call_status();
	RETURN_CCTOR(&o);
}
...
PHP_METHOD(Stub_Oo, createInstancesInLoop)
{
	...
	ZEND_HASH_FOREACH_VAL(Z_ARRVAL_P(&_0), _2)
	{
		...
		zephir_check_call_status();
		zephir_array_append(&result, &_5$$3, PH_SEPARATE, "stub/oo.zep", 108);
		ZEPHIR_CALL_METHOD(&_6$$3, &instance, "execute2", NULL, 0);
		zephir_check_call_status();
		zephir_array_append(&result, &_6$$3, PH_SEPARATE, "stub/oo.zep", 109);
