...
PHP_METHOD(Stub_Quantum, harmos)
{
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "w");
	ZEPHIR_CALL_FUNCTION(&fp, "fopen", NULL, 43, &_0, &_1);
		...
		while (1) {
			...
			if (_16$$5 <= _17$$5) {
				while (1) {
					...
					zephir_array_fetch_long(&_19$$6, &_18$$6, 0, PH_NOISY | PH_READONLY, "stub/quantum.zep", 50);
					...
					zephir_array_fetch_long(&_22$$6, &_21$$6, 0, PH_NOISY | PH_READONLY, "stub/quantum.zep", 50);
					zephir_array_fetch_long(&_23$$6, &psi, (i - 1), PH_NOISY | PH_READONLY, "stub/quantum.zep", 50);
					zephir_array_fetch_long(&_24$$6, &_23$$6, 0, PH_NOISY | PH_READONLY, "stub/quantum.zep", 51);
					ZEPHIR_INIT_NVAR(&_25$$6);
					zephir_add_function(&_25$$6, &_22$$6, &_24$$6);
					zephir_array_fetch_long(&_22$$6, &tmp, 0, PH_NOISY | PH_READONLY, "stub/quantum.zep", 51);
					zephir_array_fetch_long(&_24$$6, &psi, i, PH_NOISY | PH_READONLY, "stub/quantum.zep", 51);
					zephir_array_fetch_long(&_26$$6, &_24$$6, 0, PH_NOISY | PH_READONLY, "stub/quantum.zep", 51);
					...
					zephir_array_fetch_long(&_22$$6, &paramater, 0, PH_NOISY | PH_READONLY, "stub/quantum.zep", 51);
					ZEPHIR_INIT_NVAR(&_28$$6);
					...
					zephir_array_fetch_long(&_19$$6, &paramater, 2, PH_NOISY | PH_READONLY, "stub/quantum.zep", 51);
					zephir_array_fetch_long(&_20$$6, &v, i, PH_NOISY | PH_READONLY, "stub/quantum.zep", 51);
					zephir_array_fetch_long(&_22$$6, &_20$$6, 0, PH_NOISY | PH_READONLY, "stub/quantum.zep", 51);
					ZEPHIR_INIT_NVAR(&_27$$6);
					mul_function(&_27$$6, &_19$$6, &_22$$6);
					zephir_array_fetch_long(&_19$$6, &psi, i, PH_NOISY | PH_READONLY, "stub/quantum.zep", 51);
					zephir_array_fetch_long(&_22$$6, &_19$$6, 0, PH_NOISY | PH_READONLY, "stub/quantum.zep", 51);
					...
					zephir_array_fetch_long(&_31$$6, &_30$$6, 1, PH_NOISY | PH_READONLY, "stub/quantum.zep", 53);
					ZEPHIR_INIT_NVAR(&_25$$6);
					mul_function(&_25$$6, &_26$$6, &_31$$6);
					zephir_array_fetch_long(&_26$$6, &psi, i, PH_NOISY | PH_READONLY, "stub/quantum.zep", 53);
					zephir_array_fetch_long(&_31$$6, &_26$$6, 0, PH_NOISY | PH_READONLY, "stub/quantum.zep", 53);
					zephir_array_fetch_long(&_32$$6, &psi, i, PH_NOISY | PH_READONLY, "stub/quantum.zep", 53);
					zephir_array_fetch_long(&_33$$6, &_32$$6, 0, PH_NOISY | PH_READONLY, "stub/quantum.zep", 53);
					ZEPHIR_INIT_NVAR(&_27$$6);
			...
			if (_35$$5 <= _36$$5) {
				while (1) {
					...
					zephir_array_fetch_long(&_41$$7, &psr, (j + 1), PH_NOISY | PH_READONLY, "stub/quantum.zep", 58);
					zephir_array_fetch_long(&_42$$7, &_41$$7, 1, PH_NOISY | PH_READONLY, "stub/quantum.zep", 58);
					zephir_array_fetch_long(&_43$$7, &psr, (j - 1), PH_NOISY | PH_READONLY, "stub/quantum.zep", 58);
					zephir_array_fetch_long(&_44$$7, &_43$$7, 1, PH_NOISY | PH_READONLY, "stub/quantum.zep", 59);
					ZEPHIR_INIT_NVAR(&_45$$7);
					zephir_add_function(&_45$$7, &_42$$7, &_44$$7);
					zephir_array_fetch_long(&_42$$7, &tmp, 0, PH_NOISY | PH_READONLY, "stub/quantum.zep", 59);
					zephir_array_fetch_long(&_44$$7, &psr, j, PH_NOISY | PH_READONLY, "stub/quantum.zep", 59);
					zephir_array_fetch_long(&_46$$7, &_44$$7, 1, PH_NOISY | PH_READONLY, "stub/quantum.zep", 59);
					...
					zephir_array_fetch_long(&_40$$7, &paramater, 0, PH_NOISY | PH_READONLY, "stub/quantum.zep", 59);
					...
					zephir_array_fetch_long(&_39$$7, &paramater, 2, PH_NOISY | PH_READONLY, "stub/quantum.zep", 59);
					zephir_array_fetch_long(&_40$$7, &v, j, PH_NOISY | PH_READONLY, "stub/quantum.zep", 59);
					zephir_array_fetch_long(&_42$$7, &_40$$7, 0, PH_NOISY | PH_READONLY, "stub/quantum.zep", 59);
					ZEPHIR_INIT_NVAR(&_47$$7);
					mul_function(&_47$$7, &_39$$7, &_42$$7);
					zephir_array_fetch_long(&_39$$7, &psr, j, PH_NOISY | PH_READONLY, "stub/quantum.zep", 59);
					zephir_array_fetch_long(&_42$$7, &_39$$7, 1, PH_NOISY | PH_READONLY, "stub/quantum.zep", 59);
			...
			if (_50$$5) {
				...
				while (1) {
					...
					zephir_array_fetch_long(&_51$$9, &p2, i, PH_NOISY | PH_READONLY, "stub/quantum.zep", 67);
					ZEPHIR_INIT_NVAR(&_52$$9);
					ZVAL_STRING(&_52$$9, "%16.8lf %16.8lf %16.8lf \n");
					ZVAL_DOUBLE(&_53$$9, ((double) i * dx));
					ZVAL_DOUBLE(&_54$$9, ((double) n * dt));
					ZEPHIR_CALL_FUNCTION(NULL, "fprintf", &_55, 91, &fp, &_52$$9, &_53$$9, &_54$$9, &_51$$9);
					zephir_check_call_status();
					i = (i + 10);
				}
				ZEPHIR_INIT_NVAR(&_56$$8);
				ZVAL_STRING(&_56$$8, "\n");
				ZEPHIR_CALL_FUNCTION(NULL, "fprintf", &_55, 91, &fp, &_56$$8);
				zephir_check_call_status();
			}
			j = 1;
			while (1) {
