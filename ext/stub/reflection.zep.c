...
PHP_METHOD(Stub_Reflection, getReflectionClass)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &r, "__construct", NULL, 96, this_ptr);
...
PHP_METHOD(Stub_Reflection, getReflectionFunction)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "abs");
	ZEPHIR_CALL_METHOD(NULL, &r, "__construct", NULL, 97, &_0);
	zephir_check_call_status();
	RETURN_CCTOR(&r);
}
...
PHP_METHOD(Stub_Reflection, setReflectionParameter)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 97, parameter);
