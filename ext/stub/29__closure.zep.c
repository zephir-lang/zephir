...
ZEPHIR_INIT_CLASS(stub_29__closure)
{
	...
	zend_declare_property_null(stub_29__closure_ce, SL("name"), ZEND_ACC_PUBLIC);
	zend_declare_property_null(stub_29__closure_ce, SL("__$zephir_this"), ZEND_ACC_PUBLIC);
	return SUCCESS;
}
