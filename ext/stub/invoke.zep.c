...
PHP_METHOD(Stub_Invoke, __construct)
{
	...
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "aaa");
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 46, &_0);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Stub_Invoke, __invoke)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 46, PH_NOISY_CC | PH_READONLY);
...
PHP_METHOD(Stub_Invoke, test)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &func, "__construct", NULL, 60);
