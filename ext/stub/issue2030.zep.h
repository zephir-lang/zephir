...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_stub_issue2030_maxcodepoint, 0, 0, IS_STRING, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(arginfo_stub_issue2030_quotesandbackslashes, 0, 0, IS_STRING, 0)
ZEND_END_ARG_INFO()
...
ZEPHIR_INIT_FUNCS(stub_issue2030_method_entry) {
	...
	PHP_ME(Stub_Issue2030, maxCodepoint, arginfo_stub_issue2030_maxcodepoint, ZEND_ACC_PUBLIC)
	PHP_ME(Stub_Issue2030, quotesAndBackslashes, arginfo_stub_issue2030_quotesandbackslashes, ZEND_ACC_PUBLIC)
	PHP_FE_END
};
