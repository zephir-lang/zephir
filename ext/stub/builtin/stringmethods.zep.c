...
PHP_METHOD(Stub_BuiltIn_StringMethods, getLowerFirst) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "lcfirst", NULL, 14, &str);
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getFormatted) {
	...
	ZEPHIR_CALL_FUNCTION(&_1, "sprintf", NULL, 15, &_0, &str);
	zephir_check_call_status();
	RETURN_CCTOR(&_1);
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getSha1) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "sha1", NULL, 16, &str);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getNl2br) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "nl2br", NULL, 17, &str);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getParsedCsv) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "str_getcsv", NULL, 18, &str);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getRepeatted) {
	...
	ZVAL_LONG(&_0, count);
	ZEPHIR_CALL_FUNCTION(&_1, "str_repeat", NULL, 19, &str, &_0);
	zephir_check_call_status();
	RETURN_CCTOR(&_1);
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getShuffled) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "str_shuffle", NULL, 20, &str);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getSplited) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "str_split", NULL, 21, &str, &del);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getCompare) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "strcmp", NULL, 22, &left, &right);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getCompareLocale) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "strcoll", NULL, 23, &left, &right);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getReversed) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "strrev", NULL, 24, &str);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getHtmlSpecialChars) {
	...
	ZEPHIR_CALL_FUNCTION(&_0, "htmlspecialchars", NULL, 25, &str);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
