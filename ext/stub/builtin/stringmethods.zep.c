...
PHP_METHOD(Stub_BuiltIn_StringMethods, getLowerFirst)
{
	...
	zephir_memory_observe(&str_zv);
	ZVAL_STR_COPY(&str_zv, str);
	ZEPHIR_CALL_FUNCTION(&_0, "lcfirst", NULL, 18, &str_zv);
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getFormatted)
{
	...
	ZEPHIR_CALL_FUNCTION(&_1, "sprintf", NULL, 19, &_0, &str_zv);
	zephir_check_call_status();
	RETURN_CCTOR(&_1);
}
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getSha1)
{
	...
	zephir_memory_observe(&str_zv);
	ZVAL_STR_COPY(&str_zv, str);
	ZEPHIR_CALL_FUNCTION(&_0, "sha1", NULL, 20, &str_zv);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
}
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getNl2br)
{
	...
	zephir_memory_observe(&str_zv);
	ZVAL_STR_COPY(&str_zv, str);
	ZEPHIR_CALL_FUNCTION(&_0, "nl2br", NULL, 21, &str_zv);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
}
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getParsedCsv)
{
	...
	zephir_memory_observe(&str_zv);
	ZVAL_STR_COPY(&str_zv, str);
	ZEPHIR_CALL_FUNCTION(&_0, "str_getcsv", NULL, 22, &str_zv);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
}
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getRepeatted)
{
	...
	ZVAL_STR_COPY(&str_zv, str);
	ZVAL_LONG(&_0, count);
	ZEPHIR_CALL_FUNCTION(&_1, "str_repeat", NULL, 23, &str_zv, &_0);
	zephir_check_call_status();
	RETURN_CCTOR(&_1);
}
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getShuffled)
{
	...
	zephir_memory_observe(&str_zv);
	ZVAL_STR_COPY(&str_zv, str);
	ZEPHIR_CALL_FUNCTION(&_0, "str_shuffle", NULL, 24, &str_zv);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
}
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getSplited)
{
	...
	ZEPHIR_CALL_FUNCTION(&_0, "str_split", NULL, 25, &str_zv, &del_zv);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
}
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getCompare)
{
	...
	ZEPHIR_CALL_FUNCTION(&_0, "strcmp", NULL, 26, &left_zv, &right_zv);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
}
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getCompareLocale)
{
	...
	zephir_memory_observe(&right_zv);
	ZVAL_STR_COPY(&right_zv, right);
	ZEPHIR_CALL_FUNCTION(&_0, "strcoll", NULL, 27, &left_zv, &right_zv);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
}
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getReversed)
{
	...
	zephir_memory_observe(&str_zv);
	ZVAL_STR_COPY(&str_zv, str);
	ZEPHIR_CALL_FUNCTION(&_0, "strrev", NULL, 28, &str_zv);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
}
...
PHP_METHOD(Stub_BuiltIn_StringMethods, getHtmlSpecialChars)
{
	...
	zephir_memory_observe(&str_zv);
	ZVAL_STR_COPY(&str_zv, str);
	ZEPHIR_CALL_FUNCTION(&_0, "htmlspecialchars", NULL, 29, &str_zv);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
}
