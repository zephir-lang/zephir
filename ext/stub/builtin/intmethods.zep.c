...
PHP_METHOD(Stub_BuiltIn_IntMethods, getAbs)
{
	...
	ZVAL_LONG(&_0, num);
	ZEPHIR_CALL_FUNCTION(&_1, "abs", NULL, 18, &_0);
...
PHP_METHOD(Stub_BuiltIn_IntMethods, getBinary)
{
	...
	zephir_fetch_params(1, 1, 0, &num_param);
	ZVAL_LONG(&_0, num);
	ZEPHIR_CALL_FUNCTION(&_1, "decbin", NULL, 19, &_0);
	zephir_check_call_status();
	RETURN_CCTOR(&_1);
}
...
PHP_METHOD(Stub_BuiltIn_IntMethods, getHex)
{
	...
	zephir_fetch_params(1, 1, 0, &num_param);
	ZVAL_LONG(&_0, num);
	ZEPHIR_CALL_FUNCTION(&_1, "dechex", NULL, 20, &_0);
	zephir_check_call_status();
	RETURN_CCTOR(&_1);
}
...
PHP_METHOD(Stub_BuiltIn_IntMethods, getOctal)
{
	...
	zephir_fetch_params(1, 1, 0, &num_param);
	ZVAL_LONG(&_0, num);
	ZEPHIR_CALL_FUNCTION(&_1, "decoct", NULL, 21, &_0);
	zephir_check_call_status();
	RETURN_CCTOR(&_1);
}
...
PHP_METHOD(Stub_BuiltIn_IntMethods, getPow)
{
	...
	ZVAL_LONG(&_0, num);
	ZVAL_LONG(&_1, exp);
	ZEPHIR_CALL_FUNCTION(&_2, "pow", NULL, 22, &_0, &_1);
	zephir_check_call_status();
	RETURN_CCTOR(&_2);
}
...
PHP_METHOD(Stub_BuiltIn_IntMethods, getAtan)
{
	...
	zephir_fetch_params(1, 1, 0, &num_param);
	ZVAL_LONG(&_0, num);
	ZEPHIR_CALL_FUNCTION(&_1, "atan", NULL, 23, &_0);
	zephir_check_call_status();
	RETURN_CCTOR(&_1);
}
...
PHP_METHOD(Stub_BuiltIn_IntMethods, getLog)
{
	...
	if (base == -1) {
		ZVAL_LONG(&_0$$3, num);
		ZEPHIR_CALL_FUNCTION(&_1$$3, "log", NULL, 24, &_0$$3);
		zephir_check_call_status();
		RETURN_CCTOR(&_1$$3);
	}
	ZVAL_LONG(&_2, num);
	ZVAL_LONG(&_3, base);
	ZEPHIR_CALL_FUNCTION(&_4, "log", NULL, 24, &_2, &_3);
	zephir_check_call_status();
	RETURN_CCTOR(&_4);
}
