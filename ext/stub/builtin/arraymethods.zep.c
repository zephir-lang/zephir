...
PHP_METHOD(Stub_BuiltIn_ArrayMethods, getReversed1)
{
	...
	ZVAL_LONG(&_1, 3);
	zephir_array_fast_append(&_0, &_1);
	ZEPHIR_CALL_FUNCTION(&_2, "array_reverse", NULL, 15, &_0);
...
PHP_METHOD(Stub_BuiltIn_ArrayMethods, getMap1)
{
	...
	ZEPHIR_CALL_FUNCTION(&_2, "array_map", NULL, 16, &_1, &_0);
	zephir_check_call_status();
	RETURN_CCTOR(&_2);
}
...
PHP_METHOD(Stub_BuiltIn_ArrayMethods, issue733BuiltInJoinSpecialChars)
{
	...
	ZEPHIR_INIT_VAR(&_4);
	ZVAL_STRING(&_4, "\\\\$0");
	ZEPHIR_CALL_FUNCTION(&_5, "preg_replace", &_6, 17, &_3, &_4, b);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(b, &_5);
	ZEPHIR_INIT_VAR(&_7);
...
PHP_METHOD(Stub_BuiltIn_ArrayMethods, issue733ReversedOnVar)
{
	...
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	zephir_fetch_params(1, 1, 0, &input);
	ZEPHIR_CALL_FUNCTION(&_0, "array_reverse", NULL, 15, input);
	zephir_check_call_status();
	RETURN_CCTOR(&_0);
}
