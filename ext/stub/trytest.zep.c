...
PHP_METHOD(Stub_TryTest, testThrow2)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &_0, "__construct", NULL, 34, &message);
...
PHP_METHOD(Stub_TryTest, testTry2)
{
	...
	/* try_start_1: */
		...
		ZEPHIR_CALL_METHOD(NULL, &_0$$3, "__construct", NULL, 34, &_1$$3);
...
PHP_METHOD(Stub_TryTest, testTry4)
{
	...
	/* try_start_1: */
		...
		if (a) {
			...
			ZEPHIR_CALL_METHOD(NULL, &_0$$4, "__construct", NULL, 34, &_1$$4);
			zephir_check_call_status_or_jump(try_end_1);
			...
			ZEPHIR_CALL_METHOD(NULL, &_2$$5, "__construct", NULL, 110, &_3$$5);
			zephir_check_call_status_or_jump(try_end_1);
...
PHP_METHOD(Stub_TryTest, testTry9)
{
	...
	/* try_start_1: */
		...
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "somemethod1", NULL, 111);
		zephir_check_call_status_or_jump(try_end_1);
...
PHP_METHOD(Stub_TryTest, testTry10)
{
	...
	/* try_start_1: */
		...
		ZEPHIR_CALL_METHOD(NULL, this_ptr, "somemethod2", NULL, 112);
		zephir_check_call_status_or_jump(try_end_1);
		RETURN_MM_STRING("not catched");
