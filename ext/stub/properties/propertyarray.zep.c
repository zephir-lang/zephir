...
PHP_METHOD(Stub_Properties_PropertyArray, setOtherArray)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 86, arr);
}
...
PHP_METHOD(Stub_Properties_PropertyArray, testIssues1831)
{
	...
	while (1) {
		...
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 86, PH_NOISY_CC | PH_READONLY);
		...
		if (!ZEPHIR_IS_FALSE_IDENTICAL(&_3$$3)) {
			...
			zephir_read_property_cached(&_5$$5, this_ptr, _zephir_prop_0, 86, PH_NOISY_CC | PH_READONLY);
