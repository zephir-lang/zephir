...
PHP_METHOD(Stub_Properties_PropertyArray, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 83, &_0);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Stub_Properties_PropertyArray, setOtherArray)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 84, arr);
}
...
PHP_METHOD(Stub_Properties_PropertyArray, testIssues1831)
{
	...
	while (1) {
		...
		zephir_read_property_cached(&_0$$3, this_ptr, _zephir_prop_0, 84, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_MAKE_REF(&_0$$3);
		ZEPHIR_CALL_FUNCTION(&info, "array_shift", &_1, 91, &_0$$3);
		ZEPHIR_UNREF(&_0$$3);
		zephir_check_call_status();
		ZEPHIR_INIT_NVAR(&_2$$3);
		ZVAL_STRING(&_2$$3, "header");
		ZEPHIR_CALL_FUNCTION(&_3$$3, "stripos", &_4, 92, &info, &_2$$3);
		zephir_check_call_status();
		if (!ZEPHIR_IS_FALSE_IDENTICAL(&_3$$3)) {
			zephir_array_append(&headers, &info, PH_SEPARATE, "stub/properties/propertyarray.zep", 51);
			continue;
		} else {
			zephir_read_property_cached(&_5$$5, this_ptr, _zephir_prop_0, 84, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_MAKE_REF(&_5$$5);
			ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", &_6, 93, &_5$$5, &info);
			ZEPHIR_UNREF(&_5$$5);
			zephir_check_call_status();
			break;
		}
