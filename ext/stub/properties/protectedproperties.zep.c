...
PHP_METHOD(Stub_Properties_ProtectedProperties, setSomeVar)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 90, someVar);
	RETURN_THISW();
}
...
PHP_METHOD(Stub_Properties_ProtectedProperties, setSomeArrayVar)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 91, &someArrayVar);
	RETURN_THIS();
}
...
PHP_METHOD(Stub_Properties_ProtectedProperties, setSomeNull)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 92, param);
}
