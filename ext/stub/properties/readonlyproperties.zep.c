...
PHP_METHOD(Stub_Properties_ReadonlyProperties, __construct)
{
	...
	ZVAL_UNDEF(&_0);
	ZVAL_LONG(&_0, 42);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 99, &_0);
	ZEPHIR_INIT_VAR(&_1);
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "hello");
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 100, &_1);
	ZEPHIR_INIT_VAR(&_2);
	...
	ZVAL_STRING(&_1, "b");
	zephir_array_fast_append(&_2, &_1);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 101, &_2);
	if (1) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 102, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 102, &__$false);
	}
	ZEPHIR_INIT_NVAR(&_1);
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 103, &_1);
	ZEPHIR_MM_RESTORE();
}
