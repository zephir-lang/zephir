...
PHP_METHOD(Stub_Closures, issue2321CallPrivateCallback)
{
	...
	ZEPHIR_RETURN_CALL_METHOD(this_ptr, "issue2321filterquery", NULL, 31, &value_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Stub_Closures, issue2321filterQuery)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("preg_replace_callback", NULL, 32, &_1, &_0, &value_zv);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Stub_Closures, issue2321doUrlEncode)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("rawurlencode", NULL, 33, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Stub_Closures, issue2321ArrayMapPrivate)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("array_map", NULL, 9, &_0, &values);
	zephir_check_call_status();
	RETURN_MM();
}
