...
PHP_METHOD(Stub_Globals_ServerRequestFactory, load)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "checknullarray", &_1, 55, &server, &globalServer);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&server, &_0);
	ZEPHIR_CALL_METHOD(&_2, this_ptr, "checknullarray", &_1, 55, &files, &globalFiles);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&files, &_2);
	ZEPHIR_CALL_METHOD(&_3, this_ptr, "checknullarray", &_1, 55, &cookies, &globalCookies);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&cookies, &_3);
	ZEPHIR_CALL_METHOD(&_4, this_ptr, "checknullarray", &_1, 55, &get, &globalGet);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&get, &_4);
	ZEPHIR_CALL_METHOD(&_5, this_ptr, "checknullarray", &_1, 55, &post, &globalPost);
	zephir_check_call_status();
