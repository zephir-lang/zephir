...
PHP_METHOD(Stub_Flow, testWhileNextTest)
{
	...
	while (1) {
		...
		ZEPHIR_CALL_FUNCTION(&_0, "next", &_1, 54, variable);
		ZEPHIR_UNREF(variable);
		zephir_check_call_status();
		if (!(zephir_is_true(&_0))) {
			break;
		}
		ZEPHIR_CALL_FUNCTION(&_2$$3, "current", &_3, 55, variable);
		zephir_check_call_status();
...
PHP_METHOD(Stub_Flow, testWhileDoNextTest)
{
	...
	array_init(&returnValue);
	do {
		ZEPHIR_CALL_FUNCTION(&_0$$3, "current", &_1, 55, variable);
		zephir_check_call_status();
		zephir_array_append(&returnValue, &_0$$3, PH_SEPARATE, "stub/flow.zep", 430);
		ZEPHIR_MAKE_REF(variable);
		ZEPHIR_CALL_FUNCTION(&_2, "next", &_3, 54, variable);
		ZEPHIR_UNREF(variable);
		zephir_check_call_status();
...
PHP_METHOD(Stub_Flow, testFor1)
{
	...
	ZVAL_LONG(&_0, 4);
	zephir_array_fast_append(&b, &_0);
	if (Z_TYPE_P(&b) == IS_STRING) {
		ZEPHIR_INIT_NVAR(&_0);
		zephir_string_to_char_array(&_0, &b);
		_1 = &_0;
	} else {
		_1 = &b;
	}
	zephir_is_iterable(_1, 0, "stub/flow.zep", 443);
...
PHP_METHOD(Stub_Flow, testFor2)
{
	...
	zephir_is_iterable(_1, 0, "stub/flow.zep", 453);
...
PHP_METHOD(Stub_Flow, testFor3)
{
	...
	zephir_is_iterable(_1, 0, "stub/flow.zep", 464);
...
PHP_METHOD(Stub_Flow, testFor32)
{
	...
	if (Z_TYPE_P(e) == IS_STRING) {
		ZEPHIR_INIT_VAR(&_1);
		zephir_string_to_char_array(&_1, e);
		_0 = &_1;
	} else {
		_0 = e;
	}
	zephir_is_iterable(_0, 0, "stub/flow.zep", 703);
