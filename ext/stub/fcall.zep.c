...
PHP_METHOD(Stub_Fcall, testCall2)
{
	...
	while (1) {
		ZVAL_LONG(&_0$$3, 0);
		ZVAL_LONG(&_1$$3, 100);
		ZEPHIR_RETURN_CALL_FUNCTION("mt_rand", &_2, 42, &_0$$3, &_1$$3);
...
PHP_METHOD(Stub_Fcall, testCall3)
{
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "r");
	ZEPHIR_CALL_FUNCTION(&handle, "fopen", &_2, 43, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "outputfile.txt");
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "w");
	ZEPHIR_CALL_FUNCTION(&handle2, "fopen", &_2, 43, &_0, &_1);
	zephir_check_call_status();
	if (zephir_is_true(&handle)) {
		while (1) {
			ZVAL_LONG(&_3$$4, 4096);
			ZEPHIR_CALL_FUNCTION(&buffer, "fgets", &_4, 44, &handle, &_3$$4);
			zephir_check_call_status();
...
PHP_METHOD(Stub_Fcall, testCall5)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("str_repeat", NULL, 28, a, b);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Stub_Fcall, testCall6)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("rand", NULL, 45);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Stub_Fcall, testCall7)
{
	...
	ZEPHIR_CALL_FUNCTION(NULL, "memory_get_usage", NULL, 46);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Stub_Fcall, testCall8)
{
	...
	zephir_memory_grow_stack(ZEPHIR_METHOD_GLOBALS_PTR, __func__);
	zephir_fetch_params(1, 2, 0, &a, &b);
	ZEPHIR_CALL_FUNCTION(&x, "str_repeat", NULL, 28, a, b);
	zephir_check_call_status();
	RETURN_CCTOR(&x);
}
...
PHP_METHOD(Stub_Fcall, testStrtokVarBySlash)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "/");
	ZEPHIR_RETURN_CALL_FUNCTION("strtok", NULL, 47, value, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_FUNCTION(g_stub_zephir_global_method_test) {
	...
	ZEPHIR_RETURN_CALL_METHOD(&_0, "teststrtokvarbyslash", NULL, 48, str);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_FUNCTION(f_Stub_zephir_namespaced_method_test) {
	...
	ZVAL_LONG(&_1, 5);
	ZEPHIR_RETURN_CALL_METHOD(&_0, "testcall5", NULL, 49, str, &_1);
	zephir_check_call_status();
	RETURN_MM();
}
