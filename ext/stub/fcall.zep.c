...
PHP_METHOD(Stub_Fcall, testCall2)
{
	...
	while (1) {
		ZVAL_LONG(&_0$$3, 0);
		ZVAL_LONG(&_1$$3, 100);
		ZEPHIR_RETURN_CALL_FUNCTION("mt_rand", &_2, 31, &_0$$3, &_1$$3);
...
PHP_METHOD(Stub_Fcall, testCall3)
{
	...
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "r");
	ZEPHIR_CALL_FUNCTION(&handle, "fopen", &_2, 32, &_0, &_1);
	zephir_check_call_status();
	ZEPHIR_INIT_NVAR(&_0);
	ZVAL_STRING(&_0, "outputfile.txt");
	ZEPHIR_INIT_NVAR(&_1);
	ZVAL_STRING(&_1, "w");
	ZEPHIR_CALL_FUNCTION(&handle2, "fopen", &_2, 32, &_0, &_1);
	zephir_check_call_status();
	if (zephir_is_true(&handle)) {
		while (1) {
			ZVAL_LONG(&_3$$4, 4096);
			ZEPHIR_CALL_FUNCTION(&buffer, "fgets", &_4, 33, &handle, &_3$$4);
			zephir_check_call_status();
...
PHP_METHOD(Stub_Fcall, testCall5)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("str_repeat", NULL, 20, a, b);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Stub_Fcall, testCall6)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("rand", NULL, 34);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Stub_Fcall, testCall7)
{
	...
	ZEPHIR_CALL_FUNCTION(NULL, "memory_get_usage", NULL, 35);
	zephir_check_call_status();
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Stub_Fcall, testCall8)
{
	...
	ZEPHIR_CALL_FUNCTION(&x, "str_repeat", NULL, 20, a, b);
	zephir_check_call_status();
	RETURN_CCTOR(&x);
}
...
PHP_METHOD(Stub_Fcall, testStrtokVarBySlash)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	ZVAL_STRING(&_0, "/");
	ZEPHIR_RETURN_CALL_FUNCTION("strtok", NULL, 36, value, &_0);
	zephir_check_call_status();
	RETURN_MM();
}
