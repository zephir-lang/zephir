...
PHP_METHOD(Stub_Oo_OoDestruct, __construct)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 70, &file_zv);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_0, 70, PH_NOISY_CC | PH_READONLY);
	if ((zephir_file_exists(&_1) == SUCCESS)) {
		zephir_read_property_cached(&_2$$4, this_ptr, _zephir_prop_0, 70, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(&_3$$4, "realpath", NULL, 83, &_2$$4);
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 71, &_3$$4);
		zephir_read_property_cached(&_4$$4, this_ptr, _zephir_prop_0, 70, PH_NOISY_CC | PH_READONLY);
		...
		zephir_switch_0_clause_0: ;
			zephir_read_property_cached(&_10$$6, this_ptr, _zephir_prop_0, 70, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_FUNCTION(&_11$$6, "imagecreatefromgif", NULL, 0, &_10$$6);
			zephir_check_call_status();
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 76, &_11$$6);
			goto zephir_switch_0_end;
		zephir_switch_0_clause_1: ;
			zephir_read_property_cached(&_12$$7, this_ptr, _zephir_prop_0, 70, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_FUNCTION(&_13$$7, "imagecreatefromjpeg", NULL, 0, &_12$$7);
			zephir_check_call_status();
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 76, &_13$$7);
			goto zephir_switch_0_end;
		zephir_switch_0_clause_2: ;
			zephir_read_property_cached(&_14$$8, this_ptr, _zephir_prop_0, 70, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_FUNCTION(&_15$$8, "imagecreatefrompng", NULL, 0, &_14$$8);
			zephir_check_call_status();
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 76, &_15$$8);
			goto zephir_switch_0_end;
		zephir_switch_0_clause_3: ;
			zephir_read_property_cached(&_16$$9, this_ptr, _zephir_prop_0, 70, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_FUNCTION(&_17$$9, "imagecreatefromwbmp", NULL, 0, &_16$$9);
			zephir_check_call_status();
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 76, &_17$$9);
			goto zephir_switch_0_end;
		zephir_switch_0_clause_4: ;
			zephir_read_property_cached(&_18$$10, this_ptr, _zephir_prop_0, 70, PH_NOISY_CC | PH_READONLY);
			ZEPHIR_CALL_FUNCTION(&_19$$10, "imagecreatefromxbm", NULL, 0, &_18$$10);
			zephir_check_call_status();
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 76, &_19$$10);
			goto zephir_switch_0_end;
		zephir_switch_0_clause_5: ;
			zephir_read_property_cached(&_20$$11, this_ptr, _zephir_prop_5, 75, PH_NOISY_CC | PH_READONLY);
			if (zephir_is_true(&_20$$11)) {
				...
				if (zephir_has_constructor(&_21$$12)) {
					zephir_read_property_cached(&_23$$12, this_ptr, _zephir_prop_5, 75, PH_NOISY_CC | PH_READONLY);
		...
		zephir_read_property_cached(&_28$$4, this_ptr, _zephir_prop_6, 76, PH_NOISY_CC | PH_READONLY);
		ZVAL_BOOL(&_29$$4, 1);
		...
		if (UNEXPECTED(_30$$13)) {
			...
			if (zephir_has_constructor(&_31$$14)) {
				zephir_read_property_cached(&_33$$14, this_ptr, _zephir_prop_0, 70, PH_NOISY_CC | PH_READONLY);
		...
		zephir_check_call_status();
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_6, 76, &_37$$13);
		zephir_read_property_cached(&_35$$13, this_ptr, _zephir_prop_6, 76, PH_NOISY_CC | PH_READONLY);
		ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, 85, &_35$$13, &__$true);
		zephir_check_call_status();
		zephir_read_property_cached(&_36$$13, this_ptr, _zephir_prop_6, 76, PH_NOISY_CC | PH_READONLY);
		ZVAL_BOOL(&_38$$13, 1);
		ZEPHIR_CALL_FUNCTION(NULL, "imagesavealpha", NULL, 0, &_36$$13, &_38$$13);
		zephir_check_call_status();
		zephir_read_property_cached(&_38$$13, this_ptr, _zephir_prop_0, 70, PH_NOISY_CC | PH_READONLY);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 71, &_38$$13);
		ZVAL_UNDEF(&_39$$13);
		ZVAL_LONG(&_39$$13, width);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 72, &_39$$13);
		ZVAL_UNDEF(&_39$$13);
		ZVAL_LONG(&_39$$13, height);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 73, &_39$$13);
		ZVAL_UNDEF(&_39$$13);
		ZVAL_LONG(&_39$$13, 3);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 74, &_39$$13);
		ZEPHIR_INIT_VAR(&_40$$13);
		ZEPHIR_INIT_NVAR(&_40$$13);
		ZVAL_STRING(&_40$$13, "image/png");
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 75, &_40$$13);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Stub_Oo_OoDestruct, check)
{
	...
	ZEPHIR_INIT_VAR(&_5);
	ZVAL_STRING(&_5, ">=");
	ZEPHIR_CALL_FUNCTION(&_6, "version_compare", NULL, 75, &version, &_4, &_5);
	zephir_check_call_status();
