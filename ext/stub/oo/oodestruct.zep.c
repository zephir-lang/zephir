...
PHP_METHOD(Stub_Oo_OoDestruct, __construct) {
	...
	if ((zephir_file_exists(&_1) == SUCCESS)) {
		...
		ZEPHIR_CALL_FUNCTION(&_3$$4, "realpath", NULL, 56, &_2$$4);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&imageinfo, "getimagesize", NULL, 57, &_4$$4);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(NULL, "imagealphablending", NULL, 58, &_35$$13, &__$true);
		zephir_check_call_status();
...
PHP_METHOD(Stub_Oo_OoDestruct, check) {
	...
	ZEPHIR_INIT_VAR(&_5);
	ZVAL_STRING(&_5, ">=");
	ZEPHIR_CALL_FUNCTION(&_6, "version_compare", NULL, 59, &version, &_4, &_5);
	zephir_check_call_status();
...
PHP_METHOD(Stub_Oo_OoDestruct, getVersion) {
	...
	ZEPHIR_CALL_FUNCTION(&_4, "defined", NULL, 60, &_3);
	zephir_check_call_status();
	if (zephir_is_true(&_4)) {
		ZEPHIR_INIT_NVAR(&version);
		ZEPHIR_GET_CONSTANT(&version, "GD_VERSION");
	} else {
		ZEPHIR_CALL_FUNCTION(&info, "gd_info", NULL, 61);
		zephir_check_call_status();
