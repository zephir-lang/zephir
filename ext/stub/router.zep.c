...
PHP_METHOD(Stub_Router, __construct)
{
	...
	ZEPHIR_INIT_VAR(&_6);
	array_init(&_6);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 94, &_6);
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 95, &routes);
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Stub_Router, setDI)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 96, dependencyInjector);
}
...
PHP_METHOD(Stub_Router, setUriSource)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 97, uriSource);
	RETURN_THISW();
}
...
PHP_METHOD(Stub_Router, removeExtraSlashes)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 98, remove);
	RETURN_THISW();
}
...
PHP_METHOD(Stub_Router, setDefaultNamespace)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 99, namespaceName);
	RETURN_THISW();
}
...
PHP_METHOD(Stub_Router, setDefaultModule)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 100, moduleName);
	RETURN_THISW();
}
...
PHP_METHOD(Stub_Router, setDefaultController)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 101, controllerName);
	RETURN_THISW();
}
...
PHP_METHOD(Stub_Router, setDefaultAction)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 102, actionName);
	RETURN_THISW();
}
...
PHP_METHOD(Stub_Router, setDefaults)
{
	...
	if (zephir_array_isset_string_fetch(&module, defaults, SL("module"), 1)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 100, &module);
	}
	if (zephir_array_isset_string_fetch(&controller, defaults, SL("controller"), 1)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 101, &controller);
	}
	if (zephir_array_isset_string_fetch(&action, defaults, SL("action"), 1)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_3, 102, &action);
	}
	if (zephir_array_isset_string_fetch(&params, defaults, SL("params"), 1)) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_4, 103, &params);
	}
	RETURN_THISW();
}
...
PHP_METHOD(Stub_Router, handle)
{
	...
	zephir_read_property_cached(&_0, this_ptr, _zephir_prop_0, 98, PH_NOISY_CC | PH_READONLY);
	if (zephir_is_true(&_0)) {
	...
	ZVAL_NULL(&matches);
	if (0) {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 104, &__$true);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_1, 104, &__$false);
	}
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 105, &__$null);
	zephir_read_property_cached(&_1, this_ptr, _zephir_prop_3, 95, PH_NOISY_CC | PH_READONLY);
	...
	if (Z_TYPE_P(&_1) == IS_ARRAY) {
		ZEND_HASH_REVERSE_FOREACH_VAL(Z_ARRVAL_P(&_1), _2)
		{
			...
			if (Z_TYPE_P(&methods) != IS_NULL) {
				if (Z_TYPE_P(&request) == IS_NULL) {
					zephir_read_property_cached(&_3$$9, this_ptr, _zephir_prop_4, 96, PH_NOISY_CC | PH_READONLY);
			...
			if (Z_TYPE_P(&hostname) != IS_NULL) {
				if (Z_TYPE_P(&request) == IS_NULL) {
					...
					zephir_read_property_cached(&dependencyInjector, this_ptr, _zephir_prop_4, 96, PH_NOISY_CC);
					if (Z_TYPE_P(&dependencyInjector) != IS_OBJECT) {
			...
			if (zephir_is_true(&routeFound)) {
				...
				if (Z_TYPE_P(&matches) == IS_ARRAY) {
					...
					ZEPHIR_INIT_NVAR(&position);
					ZEPHIR_INIT_NVAR(&part);
					zephir_update_property_zval_cached(this_ptr, _zephir_prop_5, 106, &matches);
				}
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_2, 105, &route);
				break;
			}
		} ZEND_HASH_FOREACH_END();
	} else {
		...
		while (1) {
			...
			zephir_check_call_status();
				...
				if (Z_TYPE_P(&methods) != IS_NULL) {
					if (Z_TYPE_P(&request) == IS_NULL) {
						zephir_read_property_cached(&_15$$43, this_ptr, _zephir_prop_4, 96, PH_NOISY_CC | PH_READONLY);
	...
	if (!(zephir_is_true(&routeFound))) {
		...
		zephir_read_property_cached(&notFoundPaths, this_ptr, _zephir_prop_6, 107, PH_NOISY_CC);
	...
	if (zephir_is_true(&routeFound)) {
		...
		if (zephir_array_isset_string_fetch(&vnamespace, &parts, SL("namespace"), 0)) {
			if (!(zephir_is_numeric(&vnamespace))) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_7, 108, &vnamespace);
			}
			zephir_array_unset_string(&parts, SL("namespace"), PH_SEPARATE);
		} else {
			zephir_read_property_cached(&_25$$82, this_ptr, _zephir_prop_8, 99, PH_NOISY_CC | PH_READONLY);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_7, 108, &_25$$82);
		}
		zephir_memory_observe(&module);
		if (zephir_array_isset_string_fetch(&module, &parts, SL("module"), 0)) {
			if (!(zephir_is_numeric(&module))) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_9, 109, &module);
			}
			zephir_array_unset_string(&parts, SL("module"), PH_SEPARATE);
		} else {
			zephir_read_property_cached(&_26$$85, this_ptr, _zephir_prop_10, 100, PH_NOISY_CC | PH_READONLY);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_9, 109, &_26$$85);
		}
		...
		if (zephir_array_isset_string_fetch(&controller, &parts, SL("controller"), 0)) {
			if (!(zephir_is_numeric(&controller))) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_11, 110, &controller);
			}
			zephir_array_unset_string(&parts, SL("controller"), PH_SEPARATE);
		} else {
			zephir_read_property_cached(&_27$$88, this_ptr, _zephir_prop_12, 101, PH_NOISY_CC | PH_READONLY);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_11, 110, &_27$$88);
		}
		zephir_memory_observe(&action);
		if (zephir_array_isset_string_fetch(&action, &parts, SL("action"), 0)) {
			if (!(zephir_is_numeric(&action))) {
				zephir_update_property_zval_cached(this_ptr, _zephir_prop_13, 111, &action);
			}
			zephir_array_unset_string(&parts, SL("action"), PH_SEPARATE);
		} else {
			zephir_read_property_cached(&_28$$91, this_ptr, _zephir_prop_14, 102, PH_NOISY_CC | PH_READONLY);
			zephir_update_property_zval_cached(this_ptr, _zephir_prop_13, 111, &_28$$91);
		}
		...
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_15, 94, &paramsMerge);
	} else {
		zephir_read_property_cached(&_30$$96, this_ptr, _zephir_prop_8, 99, PH_NOISY_CC | PH_READONLY);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_7, 108, &_30$$96);
		zephir_read_property_cached(&_31$$96, this_ptr, _zephir_prop_10, 100, PH_NOISY_CC | PH_READONLY);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_9, 109, &_31$$96);
		zephir_read_property_cached(&_32$$96, this_ptr, _zephir_prop_12, 101, PH_NOISY_CC | PH_READONLY);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_11, 110, &_32$$96);
		zephir_read_property_cached(&_33$$96, this_ptr, _zephir_prop_14, 102, PH_NOISY_CC | PH_READONLY);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_13, 111, &_33$$96);
		zephir_read_property_cached(&_34$$96, this_ptr, _zephir_prop_16, 103, PH_NOISY_CC | PH_READONLY);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_15, 94, &_34$$96);
	}
	ZEPHIR_MM_RESTORE();
}
...
PHP_METHOD(Stub_Router, mount)
{
	...
	zephir_read_property_cached(&routes, this_ptr, _zephir_prop_0, 95, PH_NOISY_CC);
	if (Z_TYPE_P(&routes) == IS_ARRAY) {
		ZEPHIR_INIT_VAR(&_6$$11);
		zephir_fast_array_merge(&_6$$11, &routes, &groupRoutes);
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 95, &_6$$11);
	} else {
		zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 95, &groupRoutes);
	}
	RETURN_THIS();
}
...
PHP_METHOD(Stub_Router, notFound)
{
	...
	zephir_update_property_zval_cached(this_ptr, _zephir_prop_0, 107, paths);
	RETURN_THISW();
}
